...
import { testCategories, testPlaces, kilkenny, bars, cleeres } from "../fixtures.js";
...
suite("Place Model tests", () => {
  ...
  setup(async () => {
    ...
    kilkennyPlaces = await db.categoryStore.addCategory(kilkenny);
  ...
  test("get multiple places", async () => {
    const places = await db.placeStore.getPlacesByCategoryId(kilkennyPlaces._id);
